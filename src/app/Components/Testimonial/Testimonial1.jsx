			...
			<div className="row align-items-center about-bg2">
				<div className="col-lg-6">
                    ...
                    <SectionTitle
                            ...
                            Content="We give you the tools to build a healthy lifestyle. Our team of professionals will work with you to develop a comprehensive plan that will help you achieve your fitness goals. We will provide you with the tools and support you need to succeed."
                     ></SectionTitle>
					</div>
				...
				<div className="col-lg-6">
					<div className="about-thumb2">
						...
						<div className="about-shape z-100">
